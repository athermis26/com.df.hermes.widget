...
final List<Client> _mockClientsBase = [
  ...
  Client(
    ...
    numeros: [
      ...
      // Ligne fixe + ADSL au domicile
      Numero(
        numero: '+225 27 22 55 88 90',
        libelle: 'Domicile',
        contrats: const [
          Contrat(
            id: 'CTR-ADSL-55102',
            service: 'Internet',
            statut: 'Actif',
            offre: 'ADSL Essentiel 20 Mb/s',
          ),
          Contrat(
            id: 'CTR-FIX-55103',
            service: 'Fixe',
            statut: 'Actif',
            offre: 'Ligne fixe résidentielle',
          ),
        ],
        echeanceAbonnement: EcheanceAbonnement(
          libelle: 'ADSL Essentiel 20 Mb/s',
    ...
    numeros: [
      ...
      Numero(
        ...
        consommation: Consommation(
          ...
          smsRestants: 999,
          passActifs: ['Pass International EU'],
      ...
      Numero(
        ...
        contrats: const [
          ...
          Contrat(
            ...
            service: 'Fixe',
            statut: 'Actif',
            offre: 'Ligne fixe Premium illimitée',
          ),
        ],
        echeanceAbonnement: EcheanceAbonnement(
          libelle: 'Fibre 500 Mb/s + TV',
          renouvellement: DateTime(2026, 7, 1),
          montantFcfa: 39800,
        ),
        factures: [
  ...
  Client(
    ...
    numeros: [
      // Site principal : Fibre Pro + lien backup ADSL + ligne fixe
      Numero(
        numero: '+225 27 22 49 80 00',
        libelle: 'Siège',
        contrats: const [
          Contrat(
            id: 'CTR-PRO-10021',
    ...
    numeros: [
      ...
      Numero(
        ...
        consommation: Consommation(
          ...
          smsRestants: 50,
          passActifs: ['Pass Internet Hebdo 5Go'],
          consoParMois: {'M-1': 3.4, 'M': 3.8},
        ),
        echeanceAbonnement: EcheanceAbonnement(
          libelle: 'Fibre Starter 50 Mb/s',
      ...
      Numero(
        ...
        consommation: Consommation(
          ...
          dataExpiration: DateTime(2026, 6, 30),
          smsRestants: 1000,
          passActifs: ['Pass Voyage Afrique'],
          consoParMois: {'M-1': 38.0, 'M': 8.5},
        ),
        echeanceAbonnement: EcheanceAbonnement(
          libelle: 'Fibre Plus 200 Mb/s',
