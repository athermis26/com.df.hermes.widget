...
final List<AppNotification> mockNotifications = [
  AppNotification(
    ...
    titre: 'Pensez à clôturer #C-7781',
    message: 'Le dossier de K. ASSI arrive à échéance dans 12 min.',
  ...
  AppNotification(
    ...
    titre: 'Un nouveau dossier pour vous',
    message: 'Réclamation facturation – M. TRAORÉ.',
    date: DateTime(2026, 6, 10, 9, 12),
    clientIdLie: 'CLI-002',
  ),
  AppNotification(
    ...
    titre: 'SCI ELEPHANT BTP a rappelé',
    message: 'Il est de retour dans votre file d\'attente.',
